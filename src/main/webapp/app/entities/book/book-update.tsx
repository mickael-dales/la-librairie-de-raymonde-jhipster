    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="laLibrairieDeRaymondeApp.book.home.createOrEditLabel">Create or edit a Book</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : bookEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="book-resume" type="text" name="resume" />
                </AvGroup>
                <AvGroup>
                  <Label id="imageUrlLabel" for="imageUrl">
                    Image Url
                  </Label>
                  <AvField id="book-imageUrl" type="text" name="imageUrl" />
                </AvGroup>
